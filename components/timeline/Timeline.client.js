  ...
  return (
    <>
      <div className="timeline" ref={timelineRef}>
        ...
        >
          <p>
            This is my first job in Amsterdam. Young, a bit wild, russian programmer came to Amsterdam. As part of the team I was working on website https://cheaptickets.nl
          </p>
        ...
        >
          <p>
            ...
            Something like Google Optimize with a stress on developers, native integration with Google Analytics and unlimmited number of experiments per page and per site.
            https://growity.me
          </p>
        ...
        >
          ...
          <p>
            <strong>Duties:</strong>
            <ul>
              <li>Team lead of two developers</li>
            </ul>
          </p>
          ...
          <p>
            <strong>Achievements:</strong>
            <ul>
              <li>Working product that we started to sale</li>
            </ul>
          </p>
        ...
        <Item
          side="right"
          date="2020 - 2021"
          title="Telegram bot to study Dutch"
          icon={faLanguage}
        >
          <p>
          ...
          <p>
            <strong>Achievements:</strong>
            <ul>
              <li>Record of payments number (more than 100)</li>
            </ul>
          </p>
